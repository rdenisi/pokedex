...
namespace Pokedex.Tests
{
    public class PokemonServiceTests
    {
        ...
        private readonly Mock<ILogger<PokemonService>> loggerMock = new();
        ...
        {
            pokemonService = new PokemonService(loggerMock.Object, httpClientFactoryMock.Object);
        }
        ...
        [Fact]
        public async Task TranslateAsync_WhenApiResponseIsNoSuccessCode_ShouldLogTheErrorAndReturnTheDefaultDescription()
        {
            //Arrange
            var existentName = "existentPokemonName";
            ...
            var fakePokemonApiResponse = GetFakePokemonApiResponse(existentName, description);

            handlerMock
                .When(pokeApiUrl)
                .Respond(HttpStatusCode.OK, JsonContent.Create(fakePokemonApiResponse)); ;
            ...
            //Assert
            Assert.Equal(result.Description, PokemonService.ApiResponseToDto(fakePokemonApiResponse)?.Description);
